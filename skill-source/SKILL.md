...
3. **Begrijp de vraag** — welk scherm, welke componenten, welke flow? Vraag het scherm met `AskUserQuestion` (regel 12)
4. **Vraag naam + track** — één `AskUserQuestion` met beide vragen (regel 12 en 13)
