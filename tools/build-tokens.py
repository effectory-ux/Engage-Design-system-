...
# outputs live in the repo, not next to this script (which now sits in tools/)
ROOT = os.path.dirname(HERE)
DEST_CSS = os.path.join(ROOT, 'tokens.css')
DEST_JS  = os.path.join(ROOT, 'docs', 'colors-tokens.js')
